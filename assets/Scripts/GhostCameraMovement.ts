...
@ccclass('GhostCameraMovement')
export class GhostCameraMovement extends Component {
    ...
    onLoad() {
        ...
        this.fpsMovement = this.getComponent('FirstPersonCameraRotate') as FirstPersonCameraRotate;
