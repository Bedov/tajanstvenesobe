System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, systemEvent, SystemEvent, Vec3, geometry, KeyCode, PhysicsSystem, RigidBody, find, GameManager, GameStatuType, GlobalManager, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _temp, _crd, ccclass, property, KEYCODE, _pointerLockGeneral, _keyEvent, FirstPersonCameraMovementTest;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "aff9fcmgnRAv6/ZwXTsi9l9", "FirstPersonCameraMovementTest", undefined);
      ...
      _export("FirstPersonCameraMovementTest", FirstPersonCameraMovementTest = (_dec = ccclass('FirstPersonCameraMovementTest'), _dec2 = property({
        slide: true,
        range: [0.05, 0.5, 0.01]
      }), _dec(_class = (_class2 = (_temp = class FirstPersonCameraMovementTest extends Component {
        constructor() {
          super(...arguments);
        ...
        jump() {
          ...
          rigidBody === null || rigidBody === void 0 ? void 0 : rigidBody.getLinearVelocity(currentVel3);
          var raycast = new geometry.Ray(this.node.getWorldPosition().x, this.node.getWorldPosition().y, this.node.getWorldPosition().z, 0, -1, 0);
          ...
          if (PhysicsSystem.instance.raycast(raycast)) {
            ...
            if (item) {
              if (this.node.position.y - item.hitPoint.y < 1) {
                rigidBody === null || rigidBody === void 0 ? void 0 : rigidBody.setLinearVelocity(new Vec3(currentVel3.x, 5, currentVel3.z));
        ...
        update(dt) {
          ...
          if (this._keyPresed) {
            ...
            var scaledVec3 = this._finalMoveVector.multiplyScalar((_crd && GlobalManager === void 0 ? (_reportPossibleCrUseOfGlobalManager({
              error: Error()
            }), GlobalManager) : GlobalManager).getInstance().moveSpeed * this.moveSpeed * this.scaledSpeedCoeficient * this.phoneCoeficient + runningSpeed);

            var currentVel3 = new Vec3();
            (_this$node$getCompone = this.node.getComponent(RigidBody)) === null || _this$node$getCompone === void 0 ? void 0 : _this$node$getCompone.getLinearVelocity(currentVel3);
            (_this$node$getCompone2 = this.node.getComponent(RigidBody)) === null || _this$node$getCompone2 === void 0 ? void 0 : _this$node$getCompone2.setLinearVelocity(new Vec3(scaledVec3.x, currentVel3.y, scaledVec3.z)); //this.node.position.add(this._finalMoveVector.multiplyScalar(this.moveSpeed) );
          }
        }
        ...
        creatingFinalVectorKeyboard() {
          ...
          this._finalMoveVector.normalize().multiplyScalar((_crd && GlobalManager === void 0 ? (_reportPossibleCrUseOfGlobalManager({
            error: Error()
          }), GlobalManager) : GlobalManager).getInstance().moveSpeed);
        }
        ...
        creatingFinalVectorTouch(moveVec) {
          ...
          this._finalMoveVector.multiplyScalar((_crd && GlobalManager === void 0 ? (_reportPossibleCrUseOfGlobalManager({
            error: Error()
          }), GlobalManager) : GlobalManager).getInstance().moveSpeed * this.phoneCoeficient);
...
//# sourceMappingURL=FirstPersonCameraMovementTest.js.map