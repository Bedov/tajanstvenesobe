System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, math, macro, systemEvent, SystemEvent, setDisplayStats, GameManager, GameStatuType, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _temp, _crd, ccclass, property, Vec2, Vec3, Quat, v2_1, v2_2, v3_1, qt_1, KEYCODE, SlideRotateCamera;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "6f152n/6stPc7v81ZlKK38A", "SlideRotateCamera", undefined);
      ...
      _export("SlideRotateCamera", SlideRotateCamera = (_dec = ccclass('SlideRotateCamera'), _dec2 = property({
        slide: true,
        range: [0.05, 0.5, 0.01]
      }), _dec(_class = (_class2 = (_temp = class SlideRotateCamera extends Component {
        constructor() {
          super(...arguments);
        ...
        onTouchStart(_e) {
          ...
          var location = _e.getLocation(); // 获取节点坐标
        ...
        inverseCalculus() {
          if ((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          }), GameManager) : GameManager).getInstance().invertedRotation) return -1;else return 1;
        }
...
//# sourceMappingURL=SlideRotateCamera.js.map