    ...
    execute: function () {
      ...
      _export("GlobalManager", GlobalManager = (_dec = ccclass('GlobalManager'), _dec2 = property(Number), _dec3 = property(String), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(EditBoxComponent), _dec(_class = (_class2 = (_temp = _class3 = class GlobalManager extends Component {
        constructor() {
          ...
          _initializerDefineProperty(this, "LanguageBox", _descriptor13, this);
        ...
        onLoad() {
          ...
          this.setWorldArray();
          if (this.findGeneralProgress() > 0) GlobalManager.getInstance().activeLevelData.setLevelProgress(2);
        ...
        fetchGeneralDictionary() {
          var remoteUrlRoot = this.originUrl + "/" + this.LanguageName + "/" + "generalinfo.txt";
          downloading = true;
          settingData = true;
        ...
        findGeneralProgress() {
          ...
          for (var index = 0; index < GlobalManager.getInstance().levelsArray.length; index++) {
            ...
            if (GlobalManager.getInstance().levelsArray[index].status == levelStatus.finished) generalProgress++; //if(GlobalManager.getInstance().levelsArray[index].status == levelStatus.unlocked) {
        ...
        writable: true,
        initializer: null
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "LanguageBox", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
