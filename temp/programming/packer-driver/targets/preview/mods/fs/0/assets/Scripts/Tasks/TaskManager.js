System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      TrophiesManagment = _unresolved_6.TrophiesManagment;
    }, function (_unresolved_7) {
      ButtonDisabler = _unresolved_7.ButtonDisabler;
    ...
    execute: function () {
      ...
      _export("TaskManager", TaskManager = (_dec = ccclass('TaskManager'), _dec2 = property({
        ...
        checkDoneTasks() {
          ...
          for (var index = Number((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
        ...
        getDirectionFollow() {
          ...
          var node1 = instantiate(this.followPrefab);
