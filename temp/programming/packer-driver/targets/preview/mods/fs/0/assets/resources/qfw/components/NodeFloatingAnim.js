System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("NodeFloatingAnim", NodeFloatingAnim = (_dec = ccclass('NodeFloatingAnim'), _dec(_class = (_class2 = (_temp = class NodeFloatingAnim extends Component {
        constructor() {
          super(...arguments);

          _defineProperty(this, "_angles", v3(0, 0, 0));

          _defineProperty(this, "_pos", v3(0, 0, 0));

          _defineProperty(this, "_lifeTime", Math.random());
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "rotateSpeed", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=NodeFloatingAnim.js.map