  ...
  return {
    ...
    execute: function () {
      ...
      _export("FollowCamera", FollowCamera = (_dec = ccclass('FollowCamera'), _dec2 = property({
        ...
        type: Vec3
      }), _dec(_class = (_class2 = (_temp = _class3 = class FollowCamera extends Component {
        constructor() {
          super(...arguments);
          ...
          _defineProperty(this, "_targetPos", v3(0, 0, 0));

          _defineProperty(this, "_cameraPos", v3(0, 0, 0));

          _defineProperty(this, "_lookDir", v3(0, 0, -1));

          _defineProperty(this, "_lookRight", v3(1, 0, 0));

          _defineProperty(this, "_lookUp", v3(0, 1, 0));

          _defineProperty(this, "_rotate", quat());

          _defineProperty(this, "_zoom", 4);

          _defineProperty(this, "_minZoom", 2);

          _defineProperty(this, "_maxZoom", 6);

          _defineProperty(this, "_zoomSensitivty", 0.02);
        }
      ...
      }, _defineProperty(_class3, "_inst", null), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "target", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
