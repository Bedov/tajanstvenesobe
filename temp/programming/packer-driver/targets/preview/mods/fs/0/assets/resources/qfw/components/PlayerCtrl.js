  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerCtrl", PlayerCtrl = (_dec = ccclass('PlayerCtrl'), _dec2 = property({
        ...
        type: SkinningModelComponent
      }), _dec(_class = (_class2 = (_temp = _class3 = class PlayerCtrl extends Component {
        constructor() {
          super(...arguments);
          ...
          _defineProperty(this, "_isLoop", true);

          _defineProperty(this, "_anim", void 0);

          _defineProperty(this, "_curentAnimIndex", 0);

          _defineProperty(this, "_rimColor", v4(0, 0, 0, 0));

          _defineProperty(this, "_rimEnabled", false);
        }
      ...
      }, _defineProperty(_class3, "_inst", void 0), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "body", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
