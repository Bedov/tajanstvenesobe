    ...
    execute: function () {
      ...
      _export("JSONloader", JSONloader = (_dec = ccclass('JSONloader'), _dec(_class = (_temp = class JSONloader extends Component {
        ...
        fetchQuestions(folderURL, taskJSON, expectedQuestions) {
          ...
          for (var index = 1; index < Number(expectedQuestions) + 1; index++) {
        ...
        returnQuestionInput(questionURL, taskJSON) {
          ...
          var remoteUrlRoot = this.originUrl + "/" + ((_this$gameManager3 = this.gameManager) === null || _this$gameManager3 === void 0 ? void 0 : _this$gameManager3.LanguageName) + "/" + ((_this$gameManager4 = this.gameManager) === null || _this$gameManager4 === void 0 ? void 0 : _this$gameManager4.LevelName) + "/" + questionURL;
        ...
        returnQuestion(remoteUrlRoot, questionURL, taskJSON, index) {
          ...
          this.downloadInProgress = true;
          var remoteUrl = this.originUrl + "/" + ((_this$gameManager7 = this.gameManager) === null || _this$gameManager7 === void 0 ? void 0 : _this$gameManager7.LevelName) + "/" + ((_this$gameManager8 = this.gameManager) === null || _this$gameManager8 === void 0 ? void 0 : _this$gameManager8.LanguageName) + "/" + questionURL + ".txt";
        ...
        fetchQuestTekst(questURL, tekstObject) {
          ...
          this.downloadInProgress = true;
          var remoteUrlRoot = this.originUrl + "/" + ((_this$gameManager9 = this.gameManager) === null || _this$gameManager9 === void 0 ? void 0 : _this$gameManager9.LanguageName) + "/" + ((_this$gameManager10 = this.gameManager) === null || _this$gameManager10 === void 0 ? void 0 : _this$gameManager10.LevelName) + "/" + questURL;
        ...
        fetchImageQuestTekst(questURL, imageObject) {
          ...
          this.downloadInProgress = true;
          var remoteUrlRoot = this.originUrl + "/" + ((_this$gameManager13 = this.gameManager) === null || _this$gameManager13 === void 0 ? void 0 : _this$gameManager13.LanguageName) + "/" + ((_this$gameManager14 = this.gameManager) === null || _this$gameManager14 === void 0 ? void 0 : _this$gameManager14.LevelName) + "/" + questURL;
