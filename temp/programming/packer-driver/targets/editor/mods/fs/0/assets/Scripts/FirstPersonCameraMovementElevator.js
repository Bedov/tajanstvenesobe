System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1e229k9y7lBwLuZk3zWCzjS", "FirstPersonCameraMovementElevator", undefined);
      ...
      _export("FirstPersonCameraMovementElevator", FirstPersonCameraMovementElevator = (_dec = ccclass('FirstPersonCameraMovementElevator'), _dec2 = property({
        slide: true,
        range: [0.05, 0.5, 0.01]
      }), _dec(_class = (_class2 = (_temp = class FirstPersonCameraMovementElevator extends Component {
        constructor(...args) {
          super(...args);
        ...
        update(dt) {
          ...
          if (this._keyPresed) {
            ...
            (_this$node$getCompone = this.node.getComponent(RigidBody)) === null || _this$node$getCompone === void 0 ? void 0 : _this$node$getCompone.setLinearVelocity(this._finalMoveVector.multiplyScalar(this.moveSpeed * this.scaledSpeedCoeficient * this.phoneCoeficient + runningSpeed)); //this.node.position.add(this._finalMoveVector.multiplyScalar(this.moveSpeed) );
          }
        }
...
//# sourceMappingURL=FirstPersonCameraMovementElevator.js.map