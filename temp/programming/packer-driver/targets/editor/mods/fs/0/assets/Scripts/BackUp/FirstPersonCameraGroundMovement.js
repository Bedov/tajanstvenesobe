System.register(["__unresolved_0", "cc"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, macro, systemEvent, SystemEvent, Node, Vec3, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, _crd, ccclass, property, KEYCODE, _pointerLockGeneral, _keyEvent, FirstPersonCameraGroundMovement;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "2a8ad/84OFOqaSPJuvktFCk", "FirstPersonCameraGroundMovement", undefined);
      ...
      _export("FirstPersonCameraGroundMovement", FirstPersonCameraGroundMovement = (_dec = ccclass('FirstPersonCameraGroundMovement'), _dec2 = property(Node), _dec3 = property({
        slide: true,
        range: [0.05, 0.5, 0.01]
      }), _dec(_class = (_class2 = (_temp = class FirstPersonCameraGroundMovement extends Component {
        constructor(...args) {
          super(...args);
        ...
        onLoad() {
          ...
          this.fpsMovement = this.getComponent('FirstPersonCamera');
        }
...
//# sourceMappingURL=FirstPersonCameraGroundMovement.js.map