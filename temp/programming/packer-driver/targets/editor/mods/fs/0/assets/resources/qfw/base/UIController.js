    ...
    execute: function () {
      ...
      _export("UIController", UIController = class UIController extends AutoEventHandler {
        constructor(prefabUrl, layer) {
          ...
          _defineProperty(this, "_controllerId", 0);

          _defineProperty(this, "_prefabUrl", void 0);
      ...
      _defineProperty(UIController, "_idBase", 1000);

      _defineProperty(UIController, "_controllers", []);
